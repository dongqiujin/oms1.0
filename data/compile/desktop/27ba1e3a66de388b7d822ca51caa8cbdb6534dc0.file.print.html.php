<?php /* Smarty version Smarty-3.0.6, created on 2017-07-02 00:33:50
         compiled from "/data/httpd/myproject/myself/order/app/desktop/view/delivery/print.html" */ ?>
<?php /*%%SmartyHeaderCode:5782893675957ceee66a5f0-77657094%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '27ba1e3a66de388b7d822ca51caa8cbdb6534dc0' => 
    array (
      0 => '/data/httpd/myproject/myself/order/app/desktop/view/delivery/print.html',
      1 => 1498926823,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5782893675957ceee66a5f0-77657094',
  'function' => 
  array (
  ),
...
<div class="tabp pageTable" style="width:21cm; height:12.5cm; font-size:14px; background-color: white; margin-left:auto;padding-left:-30px; padding-top:10px; margin-right:auto;" id="listDiv">
    ...
    <div style="text-align: center;  line-height: 10px;">联系人：<input type="text" style="border:0px;font-size:14px;padding-top:-5px;width:70px;line-height: 20px;" value="胡先生" /> &nbsp;&nbsp;&nbsp;  手机:<input type="text" style="border:0px;font-size:14px;padding-top:-5px;width:110px;line-height: 20px;" value="15968357090" />  &nbsp;&nbsp;&nbsp; 传真：<input type="text" style="border:0px;font-size:14px;padding-top:-5px;width:130px;line-height: 20px;" value="0573-" /></div>
	...
	<table cellpadding="3" cellspacing="1" style="width:85%; border-collapse:collapse;border:none; margin-top:-25px;margin-left:30px;">
		<tbody>
			...
			<tr>
				<td>日期：<input type="text" style="border:0px;font-size:14px;padding-top:-5px;width:100px;line-height: 20px;" value="<?php echo smarty_modifier_date_format(time(),'%Y-%m-%d');?>
" /></td>
    ...
    <div style="margin-left:10px; width:20cm;margin-right:auto; padding-top:5px;margin-top:-5px;">
        <table cellpadding="3" cellspacing="0" style="width:98%; border-collapse:collapse;border:1px solid black; border-left:none; border-right:none;border-bottom:none;">
            <tr style="border-bottom:1px solid black;">
                ...
                <th width="15%" style="border-bottom:1px solid black;">产品名称</th>
                <th width="8%"  style="border-bottom:1px solid black;">尺寸</th>
                <th width="8%"  style="border-bottom:1px solid black;">颜色</th>
...
?>
            <tr style="text-align: center;">
                ...
                <td class="center" ><?php echo $_smarty_tpl->tpl_vars['product']->value['name'];?>
</td>
                <td class="center" ><?php echo $_smarty_tpl->tpl_vars['product']->value['size'];?>
</td>
                <td class="center" ><?php echo $_smarty_tpl->tpl_vars['product']->value['color'];?>
</td>
...
<?php }?></td>
            ...
            <tr style="text-align: center;">
                <td colspan="9" style="padding-left: 250px;border-top:1px solid black;">总数量：<?php echo $_smarty_tpl->tpl_vars['order']->value['total_nums'];?>
...
<script type="text/javascript">
	...
	var strHtmInstall="<br><font color='#FF00FF'>打印控件未安装!点击这里<a href='http://localhost/app/desktop/statics/js/install_lodop64.exe' target='_self'>执行安装</a>,安装后请刷新页面或重新进入。</font>";
	var strHtmUpdate="<br><font color='#FF00FF'>打印控件需要升级!点击这里<a href='http://localhost/app/desktop/statics/js/install_lodop64.exe' target='_self'>执行升级</a>,升级后请重新进入。</font>";
	var strHtm64_Install="<br><font color='#FF00FF'>打印控件未安装!点击这里<a href='http://localhost/app/desktop/statics/js/install_lodop64.exe' target='_self'>执行安装</a>,安装后请刷新页面或重新进入。</font>";
	var strHtm64_Update="<br><font color='#FF00FF'>打印控件需要升级!点击这里<a href='http://localhost/app/desktop/statics/js/install_lodop64.exe' target='_self'>执行升级</a>,升级后请重新进入。</font>";
