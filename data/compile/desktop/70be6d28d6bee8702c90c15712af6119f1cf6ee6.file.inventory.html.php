<?php /* Smarty version Smarty-3.0.6, created on 2017-07-02 00:40:55
         compiled from "/data/httpd/myproject/myself/order/app/desktop/view/order/inventory.html" */ ?>
<?php /*%%SmartyHeaderCode:17801044115957d097ac76c8-79546100%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '70be6d28d6bee8702c90c15712af6119f1cf6ee6' => 
    array (
      0 => '/data/httpd/myproject/myself/order/app/desktop/view/order/inventory.html',
      1 => 1498927253,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17801044115957d097ac76c8-79546100',
  'function' => 
  array (
  ),
...
?>
			...
			<td class="first-cell"><?php echo $_smarty_tpl->tpl_vars['product']->value['delivery_time'];?>
                ...
                <td align="center"><?php echo $_smarty_tpl->tpl_vars['product']->value['order_bn'];?>
</td>
                <td align="center"><?php echo $_smarty_tpl->tpl_vars['product']->value['name'];?>
</td>
                <td align="center"><?php echo $_smarty_tpl->tpl_vars['product']->value['size'];?>
</td>
                <td align="center"><?php echo $_smarty_tpl->tpl_vars['product']->value['color'];?>
</td>
                <td align="center"><?php echo $_smarty_tpl->tpl_vars['product']->value['num'];?>
</td>
                <td align="center"><?php echo $_smarty_tpl->tpl_vars['product']->value['send_num'];?>
</td>
                <td align="center"><?php echo number_format($_smarty_tpl->tpl_vars['product']->value['price'],3);?>
</td>
                <td align="center"><?php echo number_format($_smarty_tpl->tpl_vars['product']->value['amount'],3);?>
</td>
            ...
            <tr style="text-align: center; ">
                <td colspan="10" style="padding-left: 250px; border-top:1px #000000 solid;">总数量：<?php echo $_smarty_tpl->getVariable('totalNums')->value;?>
