<?php /* Smarty version Smarty-3.0.6, created on 2017-05-30 12:55:01
         compiled from "/data/httpd/myproject/myself/order/app/desktop/view/customer/list.html" */ ?>
<?php /*%%SmartyHeaderCode:29509251592cfb25015f39-76104859%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bf10376771f27bc40ec45e58c8018b9bd1eded75' => 
    array (
      0 => '/data/httpd/myproject/myself/order/app/desktop/view/customer/list.html',
      1 => 1496120562,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '29509251592cfb25015f39-76104859',
  'function' => 
  array (
  ),
...
<h1>
    <span class="action-span">
        <form action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['spUrl'][0][0]->__template_spUrl(array('app'=>'desktop','c'=>'ctl_customer','a'=>'index'),$_smarty_tpl);?>
" method="post" name="searchForm">
            ...
            客户名称：<input type="text" name="cus_name" id="cus_name" size="15"  value="<?php echo $_smarty_tpl->getVariable('cus_name')->value;?>
" />
...
?>
    <div style="float:left;width:10%; height:100px; margin:5px; margin-bottom:10px; text-align: center;" class="customer">
        ...
        <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['img'][0][0]->smarty_img(array('src'=>"img/dollar.png",'style'=>"cursor:hand;",'width'=>"16",'height'=>"16",'border'=>"0",'alt'=>"产品价格维护",'class'=>"price",'cus_id'=>($_smarty_tpl->tpl_vars['cus']->value['cus_id'])),$_smarty_tpl);?>

        <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['img'][0][0]->smarty_img(array('src'=>"img/order.png",'style'=>"cursor:hand;",'width'=>"16",'height'=>"16",'border'=>"0",'alt'=>"下单收货",'class'=>"order",'cus_id'=>($_smarty_tpl->tpl_vars['cus']->value['cus_id'])),$_smarty_tpl);?>
...
/cus_id/<?php echo $_smarty_tpl->tpl_vars['cus']->value['cus_id'];?>
/print_status/0">
            <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['img'][0][0]->smarty_img(array('src'=>"img/print.png",'width'=>"16",'height'=>"16",'border'=>"0",'alt'=>"发货"),$_smarty_tpl);?>
     ...
     (function($){
      $(function(){ 
            $("body").on('focus', "#cus_name", function(){
                $(this).autocomplete({
                   source: <?php echo $_smarty_tpl->getVariable('quickList')->value;?>
,
                   minLength: 0
                }).click(function() {
