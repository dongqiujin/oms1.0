<?php /* Smarty version Smarty-3.0.6, created on 2013-11-16 18:13:11
         compiled from "D:\www\flysky/app/desktop/view\order/add.html" */ ?>
<?php /*%%SmartyHeaderCode:645528745372cbe82-45560771%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e5d49f32d87a5bc00100e8aacbaeee581d6970fc' => 
    array (
      0 => 'D:\\www\\flysky/app/desktop/view\\order/add.html',
      1 => 1384579976,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '645528745372cbe82-45560771',
  'function' => 
  array (
  ),
    ...
    <table cellpadding="3" cellspacing="1">
      <thead>
        <tr>
		  ...
		  <th>金额</th>
            <th>备注</th>
          <th class="last">操作 <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['img'][0][0]->smarty_img(array('src'=>"img/add.png",'width'=>"16",'height'=>"16",'border'=>"0",'alt'=>"添加",'id'=>"addGoods"),$_smarty_tpl);?>
</th>
        </tr>
      </thead>
      <tbody id="goods_list">
...
";
        ...
        html += '<td>';
        html += '长:<input type="text" size="3" name="length[]" atype="length"  value="" required/>*';
        html += '宽:<input type="text" size="3" name="width[]" atype="width"  value="" required />*';
        html += '高:<input type="text" size="3" name="height[]" atype="height"  value="" required />';
        html += '</td>';
        html += '<td><input type="text" size="3" name="num[]" atype="num" value="" required /></td>';
        ...
        var tr = new Element('tr', {id:'gid_'+maxGid, html: html}).inject($('goods_list'));
    ...
    function changetotalgoods(e){
        ...
        //销售价
        tr.getElement('input[name=sale_price[]]').set('value', parseFloat(sale_price).toFixed(4));
        tr.getElement('span[btype=sale_price]').set('text',  parseFloat(sale_price).toFixed(4));


        //金额
        tr.getElement('input[name=amount[]]').set('value', parseFloat(num * sale_price).toFixed(4));
        tr.getElement('span[btype=amount]').set('text', parseFloat(num * sale_price).toFixed(4));
    }
